...
function App() {
    ...
    // ID de la cancion que se esta reproduciendo
    const [id, setId] = useState(1);
    // Boolean que dice si se esta reproduciendo alguna cancion
    ...
    const fetchApi = async () => {
        try {
            ...
            if (!respuesta.ok) {
                const msg = "Ha occurrido un error"
                throw new Error(msg)
            }
    ...
    useEffect(
        ...
        }, []) // se va a ejecutar cada vez que se monte el componente
